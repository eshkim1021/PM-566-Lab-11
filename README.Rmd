...
The date is not in the right format, so we need to change that into a date variable. 
...
Overall, there does seem to be a relationship between population density and deaths per 100K people. A majority of the data points fit in the 95% confidence interval calculated by geom_smooth()
...
Overall, it seems that the naive case fatality rate decreased throughout the month of September, even though it was not by a large marginl. A majority of states already had a peak in the CFR before September. 
...
The approximate peak of cases at around July 15th at around 15k. There was an increase of new deaths due to covid-19 at the end of July, so there seems to be a week to a week and a half delay between the peak of cases and peak of death. 
...
Overall, there is a decrease in the case fatality rate in most of the country today than compared with May 1st, 2020. However, the state of New York seems to have a similar case fatality rate today than it did on May 1st. And Michigan actually had an increase in the case fatality rate today compared to that of May 1st. 
